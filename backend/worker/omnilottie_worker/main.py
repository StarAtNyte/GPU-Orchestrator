"""
OmniLottie Worker
Isolated worker for omnilottie jobs
...
STREAM_KEY = "jobs:omnilottie"
GROUP_NAME = "omnilottie-workers"
WORKER_ID = os.getenv("WORKER_ID", "omnilottie-worker-1")
APP_ID = "omnilottie"
QUEUE = STREAM_KEY
...
def main():
    ...
    logger.info(f"[STARTUP] Starting OmniLottie Worker | ID={WORKER_ID}")
    ...
    from handler import OmnilottieHandler

    handler = OmnilottieHandler(redis_client=r, worker_id=WORKER_ID, state_callback=publish_state)
